import { _isPlainObject, _pluck } from "./core.internal";
...
function _fnSortData(settings, colIdx) {
  ...
  var customSort = _dt_ext.order[column.sSortDataType];
  var customData;
  ...
  // Use / populate cache
  var row, cellData;
  var formatter = _dt_ext.type.order[column.sType + "-pre"];
