...
import $ from "jquery";
import { _each, _extend } from "./core.internal";
 ...
 */
export var _fnEscapeRegex = _dt_util.escapeRegex;
 ...
 *  @memberof DataTable#oApi
 */
export function _fnFilterComplete(settings, input) {
...
function _fnFilterCreateSearch(search, inOpts) {
  ...
  search = _dt_util._normalize(search);
