import { _fnCalculateColumnWidths } from "./core.sizing";
import { _fnCompatCols, _fnCamelToHungarian } from "./core.compat";
import { _addClass, _empty, _extend, _isPlainObject } from "./core.internal";
...
import { _fnMap, _fnCallbackFire } from "./core.support";
import { _fnScrollDraw } from "./core.scrolling";
import {
  _fnGetObjectDataFn,
  _fnSetObjectDataFn,
  _fnGetCellData,
...
export function _fnColumnTypes(settings) {
  ...
  for (i = 0, ien = columns.length; i < ien; i++) {
    ...
    var autoClass = _dt_ext.type.className[col.sType];
    ...
    var renderer = _dt_ext.type.render[col.sType];
