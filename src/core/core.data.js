...
import { _fnCreateTr, _fnRowAttributes, _fnGetRowDisplay } from "./core.draw";
import { _extend, _pluck } from "./core.internal";
 ...
 */
export function _fnSplitObjNotation(str) {
...
export function _fnGetCellData(settings, rowIdx, colIdx, type) {
  ...
  if (type === "filter") {
    var fomatters = _dt_ext.type.search;
