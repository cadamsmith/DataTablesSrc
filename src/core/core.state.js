import { _each, _extend, _pluck } from "./core.internal";
import { _fnCallbackFire } from "./core.support";
import { _fnPageChange } from "./core.page";
import { _fnSortResolve } from "./core.sort";
 ...
 */
export function _fnLoadState(settings, init, callback) {
...
export function _fnImplementState(settings, s, callback) {
  ...
  var api = settings._bInitComplete ? new _dt_api(settings) : null;
